        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="form-group mt-5 mb-4 d-flex">
                    ...
                    <a class="btn" href="<?php echo site_url("aulas"); ?>"><i class="ti-arrow-left"></i> Voltar</a>
    ...
    $(document).ready(function() {
        ...
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('aulas/upload'); ?>',
                ...
                success: function(response) {
                    ...
                    if (!response.erro) {
                        ...
                        window.location.href = "<?php echo site_url("aulas"); ?>";
