                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
                        <div class="course-detail-bx">
                            <div class="course-price">
                                <!-- <del>R$ 300,00</del> -->
                                <h4 class="price">R$ <?php echo implode(',', explode('.', $curso->valor)); ?></h4>
                            </div>
                            ...
                            <div class="course-info-list scroll-page">
                                <ul class="navbar">
                                    <li><a class="nav-link" href="#overview"><i class="ti-clipboard"></i>Visão Geral</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <ul class="course-features">
                                        <li><i class="ti-book"></i> <span class="label">Nº de Disciplinas</span> <span class="value"><?php echo $qtd_disciplinas; ?></span></li>
                                    </ul>
                                </div>
