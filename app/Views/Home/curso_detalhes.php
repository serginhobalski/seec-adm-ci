    ...
    <div class='breadcrumb-row'>
        <div class='container'>
            <ul class='list-inline'>
                ...
                <li><a href="<?php echo site_url('/home/cursos') ?>"><i class='fa fa-home'></i> Cursos</a></li>
                <li><?php echo $titulo;
                    ?></li>
            </ul>
        </div>
                ...
                <div class='row d-flex flex-row-reverse'>
                        ...
                        <div class='course-detail-bx'>
                            ...
                            <div class='course-info-list scroll-page'>
                                <ul class='navbar'>
                                    ...
                                    <li><a class='nav-link' href='#curriculum'><i class='ti-bookmark-alt'></i>Disciplinas</a></li>
                    ...
                    <div class='col-lg-9 col-md-8 col-sm-12'>
                        <div class='courses-post'>
                            <div class='ttr-post-media media-effect'>
                                ...
                                <?php elseif ($curso->categoria === 'postulantes') : ?>
                                    <a href='#'><img src="<?php echo site_url('src/') ?>assets/images/blog/default/detalhe-postulantes.jpg" alt=''></a>
                                <?php elseif ($curso->categoria === 'ministerial') : ?>
                                    <a href='#'><img src="<?php echo site_url('src/') ?>assets/images/blog/default/detalhe-ministerial.jpg" alt=''></a>
                                <?php endif;
                                ?>
                            </div>
                            ...
                            <div class='row'>
                                <div class='col-md-12 col-lg-4'>
                                    <ul class='course-features'>
                                        <li><i class='ti-book'></i>
                                            <span class='label'>Nº de Disciplinas</span> <span class='value'><?php echo $qtd_disciplinas; ?></span>
                                        </li>
                                    </ul>
                                </div>
                                <div class='col-md-12 col-lg-4'>
                        ...
                        <div class='m-b30' id='matricula'>
                            <h4>Passos para matrícula no <?php echo $curso->nome ?> </h4>
                            <ul class='curriculum-list'>
                                <?php if ($curso->categoria === 'itq') : ?>
                                    <li>
                                        Realizar o pagamento no valor de <strong>R$ <?php echo implode(',', explode('.', $curso->valor)) ?></strong>
                                        através de: <br>
                                        *PIX ( Chave telefone ): <strong>91999812198</strong> <span class='text-danger'>OU</span><br>
                                        *Conta: Eurides de Assis Obalski <br>
                                        <strong>Banco do Brasil | Ag: 1232-7 | Conta: 803582174-15</strong>
                                    </li>
                                    <?php if ($curso->id == 1 || $curso->id == 7 || $curso->id == 13) : ?>
                                        <li>
                                ...
                                <?php elseif ($curso->categoria === 'postulantes') : ?>
                                    ...
                                    <li>
                                        Enviar o comprovante do pagamento <a class='btn' href='https://forms.gle/QLzm4yHLgXMPHQvTA' target="_blank"><i class="fas fa-clipboard-list"></i> Neste Formulário</a>
                                    </li>
                                <?php elseif ($curso->categoria === 'ministerial') : ?>
                                    <li>
