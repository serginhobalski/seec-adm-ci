...
<div class="row">
    <div class="col-12">
        ...
        <?php echo $this->include('Cursos/_form.php'); ?>

        <div class="form-group mt-5 mb-4 d-flex">

            <input id="btn-salvar" type="submit" value="Salvar" class="btn btn-danger mr-2">
            <a class="btn" href="<?php echo site_url("cursos"); ?>"><i class="ti-arrow-left"></i> Voltar</a>
    ...
    $(document).ready(function() {
        ...
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('cursos/cadastrar'); ?>',
                ...
                success: function(response) {
                    ...
                    if (!response.erro) {
                        ...
                        window.location.href = "<?php echo site_url("cursos"); ?>";
