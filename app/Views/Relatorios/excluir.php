...
<div class="row">
    <div class="col-12">
        ...
        <?php echo form_open("relatorios/excluir/$relatorio->id") ?>
        ...
        <div class="form-group mt-5 mb-4 d-flex">
            ...
            <a class="btn" href="<?php echo site_url("relatorios/exibir/$relatorio->id"); ?>"><i class="ti-arrow-left"></i> Cancelar</a>
